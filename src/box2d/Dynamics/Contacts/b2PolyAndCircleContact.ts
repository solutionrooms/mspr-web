// Port of Box2D/Dynamics/Contacts/b2PolyAndCircleContact.as (Box2DFlash 2.0.2), line-by-line.
// shape1 = polygon, shape2 = circle (asserted). Warm-start by id match like b2PolygonContact.
...
export class b2PolyAndCircleContact extends b2Contact {
  ...
  // b2PolyAndCircleContact.as:18-30
  ...
  // b2PolyAndCircleContact.as:32-35
  ...
  // b2PolyAndCircleContact.as:41-156
  ...
  // b2PolyAndCircleContact.as:158-161
...
registerContactType({
  ...
  createFcn: b2PolyAndCircleContact.Create,
  destroyFcn: b2PolyAndCircleContact.Destroy,
});
